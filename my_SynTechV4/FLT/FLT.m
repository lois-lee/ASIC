...
%------------------------------------------------------------------------
FixP_IIR_CAL = {2,29,'s'}; % {I,F,'s'} where 's' is signed
QType_IIR_CAL = 'SatTrc_NoWarn'; % we saturate and round

FixP_para_Q1 = {1,30,'s'};
QType_para_Q1 = 'SatTrc_NoWarn';

FixP_para_Q2 = {2,29,'s'};
QType_para_Q2 = 'SatTrc_NoWarn';

FixP_para_omega0 = {0,31,'s'};
QType_para_omega0 = 'SatTrc_NoWarn';

FixP_para_alpha = {0,31,'s'};
QType_para_alpha = 'SatTrc_NoWarn';

FixP_weight_b0 = {1,30,'s'};
QType_weight_b0 = 'SatTrc_NoWarn';

FixP_weight_b1 = {2,29,'s'};
QType_weight_b1 = 'SatTrc_NoWarn';

FixP_weight_a0 = {1,30,'s'};
QType_weight_a0 = 'SatTrc_NoWarn';

FixP_weight_a1 = {2,29,'s'};
QType_weight_a1 = 'SatTrc_NoWarn';

FixP_weight_a2 = {0,31,'s'};
QType_weight_a2 = 'SatTrc_NoWarn';

FixP_in = {0,31,'s'}; % {I,F,'s'} where 's' is signed
QType_in = 'SatTrc_NoWarn'; % we saturate and round

FixP_out = {0,23,'s'}; % {I,F,'s'} where 's' is signed
QType_out = 'SatTrc_NoWarn'; % we saturate and round

FixP_inter_y = {1,30,'s'};
QType_inter_y = 'SatTrc_NoWarn';

FixP_inter_x = {0,31,'s'};
QType_inter_x = 'SatTrc_NoWarn';
