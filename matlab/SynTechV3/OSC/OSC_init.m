...
par.OSC.Deltaf_DI = [0,5,-5]; % increase the waves' frequency
par.OSC.Multf_DI = [1,1,1]; % multiply the waves' frequency
par.OSC.Weight_SI = [0.33,0.33,0.33]; % assignt weight to each wave

par.OSC.Thld_SI(1) = RealRESIZE(par.OSC.Thld_SI(1),{0,31,'s'},'WrpTrc_NoWarn');
par.OSC.Thld_SI(2) = RealRESIZE(par.OSC.Thld_SI(2),{0,31,'s'},'WrpTrc_NoWarn');
par.OSC.Thld_SI(3) = RealRESIZE(par.OSC.Thld_SI(3),{0,31,'s'},'WrpTrc_NoWarn');

par.OSC.Deltaf_DI(1) = RealRESIZE(par.OSC.Deltaf_DI(1),{4,27,'s'},'WrpTrc_NoWarn');
par.OSC.Deltaf_DI(2) = RealRESIZE(par.OSC.Deltaf_DI(2),{4,27,'s'},'WrpTrc_NoWarn');
par.OSC.Deltaf_DI(3) = RealRESIZE(par.OSC.Deltaf_DI(3),{4,27,'s'},'WrpTrc_NoWarn');

par.OSC.Multf_DI(1) = RealRESIZE(par.OSC.Multf_DI(1),{15,17,'u'},'WrpTrc_NoWarn');
par.OSC.Multf_DI(2) = RealRESIZE(par.OSC.Multf_DI(2),{15,17,'u'},'WrpTrc_NoWarn');
par.OSC.Multf_DI(3) = RealRESIZE(par.OSC.Multf_DI(3),{15,17,'u'},'WrpTrc_NoWarn');
...
par.GLO.FSInt_DI=RealRESIZE(sta.GLO.FSInt_DO,{32,0,'u'},'WrpTrc_NoWarn');
sta.INP.Freq_DO=RealRESIZE(sta.INP.Freq_DO,{32,0,'u'},'WrpTrc_NoWarn');
