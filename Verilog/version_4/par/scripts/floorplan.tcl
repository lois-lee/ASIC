...
editPin -cell ${DESIGNFULL} -fixOverlap 1 -spreadDirection clockwise        -edge 2 -layer 3 -spreadType start -unit TRACK -spacing 50 -offsetStart 15 -pin {WrEn_SI Rst_RBI Clk_CI Addr_DI* PAR_In_DI*}
editPin -cell ${DESIGNFULL} -fixOverlap 1 -spreadDirection clockwise        -edge 0 -layer 3 -spreadType start -unit TRACK -spacing 14 -offsetStart 15 -pin {NYQ_In_DI*}
editPin -cell ${DESIGNFULL} -fixOverlap 1 -spreadDirection clockwise        -edge 3 -layer 3 -spreadType start -unit TRACK -spacing 14 -offsetStart 15 -pin {NYQ_Out_DO*}
editPin -cell ${DESIGNFULL} -fixOverlap 1 -spreadDirection counterclockwise -edge 1 -layer 3 -spreadType start -unit TRACK -spacing 14 -offsetStart 15 -pin {NYQ_Valid_DO}
