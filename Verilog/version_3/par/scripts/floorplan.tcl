...
floorPlan -site unit -d 100.16 100.16 14.08 14.08 14.08 14.08
 
#TODO: Change pins
setPinAssignMode -pinEditInBatch True
editPin -cell ${DESIGNFULL} -fixOverlap 1 -spreadDirection clockwise        -edge 2 -layer 3 -spreadType start -unit TRACK -spacing 50 -offsetStart 15 -pin {WrEn_SI Rst_RBI Clk_CI  Cin_DI Cout_DO}
editPin -cell ${DESIGNFULL} -fixOverlap 1 -spreadDirection clockwise        -edge 0 -layer 3 -spreadType start -unit TRACK -spacing 14 -offsetStart 15 -pin {A_DI*}
editPin -cell ${DESIGNFULL} -fixOverlap 1 -spreadDirection clockwise        -edge 3 -layer 3 -spreadType start -unit TRACK -spacing 14 -offsetStart 15 -pin {B_DI*}
editPin -cell ${DESIGNFULL} -fixOverlap 1 -spreadDirection counterclockwise -edge 1 -layer 3 -spreadType start -unit TRACK -spacing 14 -offsetStart 15 -pin {Sum_DO*}
